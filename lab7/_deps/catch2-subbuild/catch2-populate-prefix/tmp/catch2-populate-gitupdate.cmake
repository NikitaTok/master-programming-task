...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref v3.4.0
  WORKING_DIRECTORY "/workspaces/master-programming-task/lab7/_deps/catch2-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v3.4.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v3.4.0")
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 v3.4.0
  WORKING_DIRECTORY "/workspaces/master-programming-task/lab7/_deps/catch2-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/master-programming-task/lab7/_deps/catch2-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/master-programming-task/lab7/_deps/catch2-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
